# Contributing to `tree-operations`

Love tree-operations and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/yeutech-lab/tree-operations/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/tree-operations.git
   # Navigate to the newly cloned directory
   cd tree-operations
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kopax/tree-operations.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/yeutech-lab/tree-operations/blob/master/LICENSE.md).
